...
export interface complexLogicType<ActionType, ActionForm, FormInstance, AntdFieldData> extends Logic {
    actionCreators: {
        ...
        inspectElementSelected: (element: HTMLElement, index: number | null) => {
    ...
    key: undefined;
    listeners: {
        hideButtonActions: ((action: {
            type: 'hide button actions (samples.complexLogic)';
            payload: {
                value: boolean;
            };
        }, previousState: any) => void | Promise<void>)[];
        setShowActionsTooltip: ((action: {
            type: 'set show actions tooltip (samples.complexLogic)';
            payload: {
                showActionsTooltip: boolean;
            };
    ...
    __keaTypeGenInternalSelectorTypes: {
        ...
        selectedEditedAction: (arg1: ActionType | null, arg2: ActionForm, arg3: FormInstance | null, arg4: AntdFieldData[] | null, arg5: number | null, arg6: number) => ActionForm;
    };
}
